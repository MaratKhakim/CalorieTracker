...
class DefaultPreferences(
    ...
    override fun saveActivityLevel(level: ActivityLevel) {
        sharedPref.edit()
            .putString(Preferences.KEY_ACTIVITY_LABEL, level.name)
            .apply()
    }
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        val activityLevelString = sharedPref.getString(Preferences.KEY_ACTIVITY_LABEL, null)
        ...
        return UserInfo(
            ...
            fatRatio = fatRatio,
            goalType = GoalType.fromString(goalType ?: "medium"),
            activityLevel = ActivityLevel.fromString(activityLevelString ?: "keep_weight")
        )
    }
}